---
title: 'Assignment 03: Data Classification using the Keras Functional API'
...
- How to implement a 2-class classification neural network with a single hidden layer
- How representational power effects the types of decision boundary a model can form for a classification problem.
